...
public class DefaultCloudServiceFactoryTest {
    ...
    private ComponentContext getMockComponentContext(Collection<ServiceReference<CloudConnectionService>> refs) {
        try {
            final BundleContext context = mock(BundleContext.class);

            when(context.getServiceReferences(CloudConnectionService.class, null)).thenReturn(refs);
    ...
    private ServiceReference<CloudConnectionService> createMockReference(final String pid, final String factoryPid,
        ...
        final ServiceReference<CloudConnectionService> ref = mock(ServiceReference.class);
    ...
    public void testGetManagedCloudServicePids() throws KuraException {
        ...
        List<ServiceReference<CloudConnectionService>> list = new ArrayList<>();
