...
final class CloudPublisherOptions {
    ...
    private static final String CLOUD_PUBLISHER_PID = "publisher.pid";

    private static final String CONF_POSITION = "publish.position";

    private static final String DEFAULT_CLOUD_PUBLISHER_PID = "publisher.pid";
    ...
    /**
     * Returns the kura.service.pid of the cloud publisher to be used to publish the generated messages
     *
     * @return the kura.service.pid of the cloud publisher to be used.
     */
    String getCloudPublisherPid() {
        String cloudPublisherPid = DEFAULT_CLOUD_PUBLISHER_PID;
        Object configCloudPublisherPid = this.properties.get(CLOUD_PUBLISHER_PID);
